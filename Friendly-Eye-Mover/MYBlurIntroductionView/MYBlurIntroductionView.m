...
-(void)initializeViewComponents{
    ...
    //Page Control
//    self.PageControl = [[UIPageControl alloc] initWithFrame:CGRectMake((self.frame.size.width - kPageControlWidth)/2, self.frame.size.height - 35, kPageControlWidth, 37)];
    self.PageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.frame.size.height - 35, self.frame.size.width, 37)];
    ...
    self.LeftSkipButton.backgroundColor = [UIColor grayColor];
    ...
    self.RightSkipButton.frame = CGRectMake(self.frame.size.width - skipStringWidth - kLeftRightSkipPadding, self.frame.size.height - 35, skipStringWidth, 37);
    [self.RightSkipButton.titleLabel setFont:kSkipButtonFont];
    self.RightSkipButton.backgroundColor = [UIColor grayColor];
